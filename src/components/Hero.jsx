...
const Hero = () => {
	return (
		...
		<div className="bg-gray-50 dark:bg-chai-bg min-h-screen transition-colors duration-300">
			<div className="bg-gray-50 dark:bg-[#1e1e1e] min-h-screen">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					{/* Main Heading */}
					<h1 className="text-4xl font-bold text-gray-900 dark:text-chai-text sm:text-5xl md:text-6xl">
